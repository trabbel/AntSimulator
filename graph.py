...
e = 0
mal_frac = str(("%.6f" % (2**-m)))
hell_evpr_multi = str(e)
filename = "AntSimData_SIM_STEPS-50000_SIM_ITERS-4_mal_frac-"+mal_frac+"_mal_delay-100_mal_ants_focus-1_ant_tracing-1_ctr_pherm-0_hell_phermn_intens-1.000000_hell_phermn_evpr-"+hell_evpr_multi+".000000_dil_max-500_dil_incr-500_iter-41.csv"
...
plt.setp(l1,linestyle='-', linewidth=6) 
plt.setp(l2,linestyle='--', linewidth=6) 
plt.setp(l3, linestyle=':', linewidth=6)
plt.setp(l4, linestyle='-.', linewidth=6)  
...
plt.savefig("graphs/6-oct_morning/"+filename+".png",dpi = 400, facecolor=host.get_facecolor())
